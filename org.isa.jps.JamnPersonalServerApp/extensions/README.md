...
Example of a minimum Java extension file e.g. [Sample Command Extension](https://github.com/iqbserve/JamnServer/blob/master/sample/org.isa.jps.SampleCommand/src/main/java/org/isa/jps/SampleCommand.java)
